    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.antoniaklja.generated.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.antoniaklja.generated.AWSECommerceService.class.getResource(".");
            url = new URL(baseUrl, "http://webservices.amazon.com/AWSECommerceService/AWSECommerceService.wsdl?rw_useCurrentProtocol=1");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://webservices.amazon.com/AWSECommerceService/AWSECommerceService.wsdl?rw_useCurrentProtocol=1', retrying as a local file");
